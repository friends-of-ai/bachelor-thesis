	...
	\label{sec:section_validation_process}
		...
		\subsection{Accuracy and evaluations}
			...
			\subsubsection{Influence of the number of trained layers on the accuracy}
				...
				\en{The idea of not training the lowest layers is unfortunately not a good idea. You can save a lot of computing time if you only train the last 36 levels (about one hour of computing time compared to two and a half hours if you train all levels), but the accuracy of the model increases steadily with the training of additional layers. The model accuracy could be improved from 64.8\% to 83.6\% when training all levels. It is a good idea to invest in computing time to get good models.}
