	...
	\label{sec:section_results}
		...
		\label{sec:section_model_validation}
			...
			\subsubsection{Influence of dropout}
				...
				\begin{lstlisting}[frame=single,caption={Example of a dropout layer after the CNN model},captionpos=b,basicstyle=\small,language=Python,label=lst:lstlisting_python_dropout]
