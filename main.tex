				...
				\begin{figure}[H]
					...
					\begin{tikzpicture}
						...
						\draw[fill=white, opacity=0, draw=white]
							(0 * \inputImageWidth, 0 * \inputImageWidth + 1.5) --
							(1 * \inputImageWidth, 0 * \inputImageWidth + 1.5) --
							(1 * \inputImageWidth, 1 * \inputImageWidth + 1.5) --
							(0 * \inputImageWidth, 1 * \inputImageWidth + 1.5) --
							(0 * \inputImageWidth, 0 * \inputImageWidth + 1.5);
