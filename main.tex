	...
	\section{Background}
		...
		\subsubsection{Classification Metrics}
			...
			\paragraph{Accuracy}
				...
				\begin{equation}
					Acc_{top-1} = {{\#predictions_{correct}} \over {\#predictions_{all}}}
				\end{equation}
			 ...
			 \paragraph{Confusion matrix}
			 	...
			 	\de{Die Confusion Matrix ist nicht wirklich eine Metrik, aber sie erlaubt es die nachfolgenden Metriken besser zu verstehen:}
			 	\en{The Confusion Matrix is not really a metric, but it allows to better understand the following metrics:}
			 
				\[
					confusion\ matrix = \begin{bmatrix}
						\#_{class_{1}@real\ class_{1}} & \dots & \#_{class_{n}@real 	\ class_{1}} \\
						\vdots & \ddots & \vdots \\
						\#_{class_{n}@real\ class_{1}} & \dots & \#_{class_{n}@real\ class_{n}}
					\end{bmatrix}
				\]
