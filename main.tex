	...
	\label{sec:section_results}
		...
		\label{sec:section_model_validation}
			...
			\subsubsection{Influence of different error optimizers}
				...
				\begin{equation}
					\boldsymbol \lambda_{new} = \boldsymbol \lambda_{current} - \eta \cdot L_r(\vartheta, \boldsymbol \lambda_{current})
				\end{equation}
				...
				\label{sec:section_influence_of_the_momentum_and_the_nesterov_momentum}
					...
					\begin{equation}
						...
						\nabla \boldsymbol \lambda_{new} = \alpha \cdot \nabla \boldsymbol \lambda_{old} - \eta \cdot L_r(\vartheta, \boldsymbol \lambda_{current})
					\end{equation}
					...
					\begin{equation}
						...
						\boldsymbol \lambda_{new} = \boldsymbol \lambda_{current} + \alpha \cdot \nabla \boldsymbol \lambda_{old} - \eta \cdot L_r(\vartheta, \boldsymbol \lambda_{current} + \alpha \cdot \nabla \boldsymbol \lambda_{old})
					\end{equation}
