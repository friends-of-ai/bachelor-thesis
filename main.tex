				...
				\begin{figure}[H]
					...
					\begin{tikzpicture}
						...
						\draw[fill=red,draw=black,opacity=0.8]
							...
							(12.5,0.5);
					\end{tikzpicture}
					\caption[Architecture of a traditional \acl{cnn} with transfer learning]{The green area (see figure~\ref{fig:traditional-convolutional-network}) was replaced by a new \acl{nn} (red) adapted to the new problem.}
