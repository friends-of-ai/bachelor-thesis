		...
		\label{sec:section_machine_learning}
			...
			\subsubsection{Convolutional Neuronal Network}
				...
				\begin{figure}[H]
					\centering
					\begin{tabular}{ ccccc }
						image matrix & & filter matrix & & output matrix \\
						...
						\begin{tabular}{|c|c|c|}
							...
							0 & 0 & 1\\
							\hline
						\end{tabular} & \LARGE{$\Rightarrow$} &

						\begin{tabular}{|c|c|c|c|}
							\hline
							\tikzmark{tl12}1\tikzmark{br12} & 0 & 1 & 1\\
							\hline
							0 & 1 & 0 & 1\\
							\hline
							0 & 0 & \tikzmark{tl22}1\tikzmark{br22} & 1\\
							\hline
							0 & 0 & 1 & 1\\
							\hline
						\end{tabular}\\
					...
					\caption[Simple convolution.]{Simple convolution}
				\end{figure}
