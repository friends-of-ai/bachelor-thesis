				...
				\begin{figure}[H]
					...
					\begin{tikzpicture}
						...
						\draw[fill=red,draw=black,opacity=0.8]
							...
							(12.5,0.5);
					\end{tikzpicture}
					\caption[Architecture of a traditional convolutional neural network with transfer learning]{The green area (the neural network) was replaced by a network (red) adapted to the new problem (see \fullref{fig:traditional-convolutional-network}).}
