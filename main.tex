...
\begin{document}
	...
	\section{Introduction}
		...
		\label{sec:section_insufficient_amount_of_data}
			...
			\en{Depending on the number of classes to be trained, one will quickly arrive at the required data set, which consists of several gigabytes of data. With \acf{tl} it is possible to reduce this number a little bit, but the problem of the large amount of data remains. A paper  from Microsoft in 2001\autocite{banko2001scaling} showed at that time that simple algorithms with enough data gave similar results as complex algorithms based on less data. The researchers referred to data which should classify language constructs:}
